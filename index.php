            ...
            <section class="messages">
                <?php
                    ...
                    while($donnees = $stmt->fetch()) {
                            echo '<div class="message message--me"><p class="message__content">'. $donnees['message_content'] .'</p></div>';                  
                        }
                ?>
                <div class="message message--friend"><div class="container"><p class="message__author">Clement</p><p class="message__content">Wsh le sang</p></div></div>
            </section>
